...
class RandomExtensions{
    ...
    fun Map<Vector2d, WorldElement>.randomFreePosition(mapSize: Vector2d): Vector2d? {  // zakladam ze mapSize jest prawym gornym wierzcholkiem, prostokata, ktory ograniczna mape
